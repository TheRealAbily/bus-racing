...
def section_11():
    ...
    # Text:
    text(front_c('W') + styles_c('B') + '- Enter the new' + front_c('Y') + ' sound effects volume ' + front_c('W') + 'value ( ' + front_c('C') + 'Current: ' + front_c('Y') + f'{round(c.VOLUME_SFX * 100)}%' + front_c('W') + ' )' + styles_c('N'), x=c.EDGE_X + 25, next=3)
