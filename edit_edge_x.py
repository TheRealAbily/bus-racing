...
def section_8():
    ...
    print(back_c('B') + front_c('Y') + (' ' * c.EDGE_X) + (' ' * distance_left) + back_c('W') + '   ' + back_c('B') + '    ' + back_c('W') + '  ' + back_c('B') + ' ' + back_c('W') + '  ' + back_c('B') + '  ' + back_c('W') + ' ' + back_c('B') + '  ' + back_c('W') + '  ' + back_c('B') + '  ' + back_c('W') + '   ' + back_c('B') + '         ' + back_c('W') + ' ' + back_c('B') + '   ' + (' ' * distance_right) + front_c('Y'))
    print(back_c('B') + front_c('Y') + (' ' * c.EDGE_X) + (' ' * distance_left) + back_c('W') + ' ' + back_c('B') + '      ' + back_c('W') + '  ' + back_c('B') + ' ' + back_c('W') + '  ' + back_c('B') + '  ' + back_c('W') + ' ' + back_c('B') + '   ' + back_c('W') + ' ' + back_c('B') + '  ' + back_c('W') + ' ' + back_c('B') + '          ' + back_c('W') + ' ' + back_c('B') + ' ' + back_c('W') + ' ' + back_c('B') + ' ' + (' ' * distance_right) + front_c('Y'))
    print(back_c('B') + front_c('Y') + (' ' * c.EDGE_X) + (' ' * distance_left) + back_c('W') + '     ' + back_c('B') + '  ' + back_c('W') + '    ' + back_c('B') + '    ' + back_c('W') + '   ' + back_c('B') + '   ' + back_c('W') + '     ' + back_c('B') + '     ' + back_c('W') + ' ' + back_c('B') + '   ' + back_c('W') + ' ' + back_c('B') + ' ' + (' ' * distance_right) + front_c('Y'))
    ...
    # Text:
    text(front_c('W') + styles_c('B') + '- Enter the new value of the' + front_c('Y') + ' X axis ' + front_c('W') + '( ' + front_c('C') + 'Current: ' + front_c('Y') + f'{round(c.EDGE_X)}' + front_c('W') + ' )' + styles_c('N'), x=c.EDGE_X + 25, next=3)
    
    print((' ' * (c.EDGE_X + 28)), front_c('W') + styles_c('B') + '- ' + front_c('G') + 'New value ' + front_c('W') + '( ' + front_c('C') + 'Min: ' + front_c('Y') + '1' + front_c('W') + ' - ' + front_c('C') + 'Max: ' + front_c('Y') + '50' + front_c('W') + ' ): ' + styles_c('N') + front_c('W'), end='', sep='')
